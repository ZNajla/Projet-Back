...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Models.Detail_Processus", b =>
                {
            ...
            modelBuilder.Entity("Application.Models.Processus", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Application.Models.Tache", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Application.Models.Types", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Application.Models.Detail_Processus", b =>
                {
                    b.HasOne("Application.Models.Processus", "Processus")
            ...
            modelBuilder.Entity("Application.Models.Document", b =>
                {
                    b.HasOne("Application.Models.Types", "Types")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("TacheUser", b =>
                {
                    b.HasOne("Application.Models.Tache", null)
                        .WithMany()
